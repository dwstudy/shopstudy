...
<html lang="en">
    <head>
        ...
        <link href="{{ asset ('site/vendors/line-icon/css/simple-line-icons.css') }}" rel="stylesheet">
        <link href="{{ asset ('site/vendors/elegant-icon/style.css') }}" rel="stylesheet">
        <!-- Bootstrap -->
        ...
        <link href="{{ asset('site/vendors/bootstrap-selector/css/bootstrap-select.min.css') }}" rel="stylesheet">
                            ...
                            <div class="top_header_left">
                                <div class="selector">
                                    <select class="language_drop" name="countries" id="countries" style="width:300px;">
                                      <option value='yt' data-image="{{asset('site/img/icon/flag-1.png')}}" data-imagecss="flag yt" data-title="English">English</option>
                                      <option value='yu' data-image="{{asset('site/img/icon/flag-1.png')}}" data-imagecss="flag yu" data-title="Bangladesh">Bangla</option>
                                      <option value='yt' data-image="{{asset('site/img/icon/flag-1.png')}}" data-imagecss="flag yt" data-title="English">English</option>
                                      <option value='yu' data-image="{{asset('site/img/icon/flag-1.png')}}" data-imagecss="flag yu" data-title="Bangladesh">Bangla</option>
                                    </select>
                                </div>
            ...
            <div class="carousel_menu_inner">
                <div class="container">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        <a class="navbar-brand" href="#"><img src="{{asset('site/img/logo.png')}}" alt=""></a>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        ...
        <script src="{{asset('site/vendors/revolution/js/extensions/revolution.extension.slideanims.min.js')}}"></script>
        <!-- Extra plugin css -->
        <script src="{{asset('site/vendors/counterup/jquery.waypoints.min.js')}}"></script>
        <script src="{{asset('site/vendors/counterup/jquery.counterup.min.js')}}"></script>
        <script src="{{asset('site/vendors/owl-carousel/owl.carousel.min.js')}}"></script>
        <script src="{{asset('site/vendors/bootstrap-selector/js/bootstrap-select.min.js')}}"></script>
        <script src="{{asset('site/vendors/image-dropdown/jquery.dd.min.js')}}"></script>
        <script src="{{asset('site/js/smoothscroll.js')}}"></script>
        <script src="{{asset('site/vendors/isotope/imagesloaded.pkgd.min.js')}}"></script>
        <script src="{{asset('site/vendors/isotope/isotope.pkgd.min.js')}}"></script>
        <script src="{{asset('site/vendors/magnify-popup/jquery.magnific-popup.min.js')}}"></script>
        <script src="{{asset('site/vendors/vertical-slider/js/jQuery.verticalCarousel.js')}}"></script>
